...
vv cookiecutter --no-input -o "$out" -f "$u" \
    ...
    lname="quayscripts" \
    eggname="quayscripts" \
    infra_domain="github.com" \
    simple_docker_image="corpusops/quayscripts" \
    py_ver="3.8" \
    with_db="" \
    with_mailcatcher="" \
    with_node="" \
    ...
    git_project="quayscripts" \
    git_scheme="https" \
    git_user="" \
    git_project_url="https://github.com/corpusops/quayscripts" \
    out_dir="." \
    docker_registry="" \
    app_type="simplecompose" \
    ck_type="simplecompose" \
    docker_image="corpusops/quayscripts" \
